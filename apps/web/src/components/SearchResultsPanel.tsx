          ...
          {section.items.map((item) => {
            ...
            return (
              <button
                ...
                className={
                  "flex w-full cursor-pointer items-center justify-between rounded-md px-3 py-2 text-left text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring " +
                  (isSelected
